...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    """
    The client should not be able to send a token
    along with a registration request
    Making 'token' read-only handles that for us
    """
...
class LoginSerializer(serializers.Serializer):
    """
    Authenticates existing user. Email and password are required.
    return json web token
    """
